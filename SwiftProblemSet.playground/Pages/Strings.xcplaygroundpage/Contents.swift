...
let favoriteMovie = "The Goonies"
let favoriteQuote = "Goonies never say die!"
let combinedInterests = favoriteMovie + " always said, " + favoriteQuote
//: ### Exercise 7
...
//desired output = "$5.67"
print("$\(numOfPennies / 100).\(numOfPennies % 100)", terminator: "")
